...
```
cd existing_repo
git remote add origin https://gitlab.com/authenticator4/medaiwiki.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/authenticator4/medaiwiki/-/settings/integrations)
